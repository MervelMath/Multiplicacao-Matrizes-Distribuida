...
namespace Wcf.Client
{
    ...
    class ProgramThreadUnicaClient
    {
        ...
        private static void FazerComunicação()
        {
            ...
            {
                return proxy?.MultiplicaMatrizes(matrizABytes, matrizBBytes, range);
            });
            ...
            SalvaMatrizCEmArquivo(matrizC1Desserializada, range);
        ...
        private static void SalvaMatrizCEmArquivo(double[,] matrizA, int range)
        {
